...
The appliance uses a USB audio interface to take input from your mixer. The input signal is then redirected to the output of the USB audio inteface such that it can be used locally by another application, like FM transmission for the hard of hearing. This inline installation reduces the number of outputs required from your mixer.
